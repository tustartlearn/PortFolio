...
const Data = () => {
  ...
  const handleClose = (value) => {
    setAnchorEl(null);
    setSelectedPercentRange(value);
  };

  const filteredData =
    selectedPercentRange === "View All"
      ? tableData
      : tableData.filter((row) => {
          const percent = parseInt(row.percentScore.replace("%", ""), 10);
          if (selectedPercentRange === "90-100%") return percent >= 90 && percent <= 100;
          if (selectedPercentRange === "75-89%") return percent >= 75 && percent < 90;
          if (selectedPercentRange === "Below 75%") return percent < 75; 
          if (selectedPercentRange === "Below 65%") return percent < 65; 
            ...
            >
              ...
              <Box sx={{ mt: { xs: 2, sm: 0 } }}>
                ...
                >
                  ...
                  <MenuItem onClick={() => handleClose("90-100%")}>90-100%</MenuItem>
                  <MenuItem onClick={() => handleClose("75-89%")}>75-89%</MenuItem>
                  <MenuItem onClick={() => handleClose("Below 75%")}>76-65%</MenuItem> 
                  <MenuItem onClick={() => handleClose("Below 65%")}>Below 65%</MenuItem>
                  <MenuItem onClick={() => handleClose("Below 55%")}>Below 55%</MenuItem>
                  <MenuItem onClick={() => handleClose("Below 45%")}>Below 45%</MenuItem>
                </Menu>
              </Box>
            </Box>
